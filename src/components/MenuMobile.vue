<template>
  <div
    ...
    <nav class="flex justify-around p-3 text-gray-700 dark:text-gray-300 relative">
      ...
      <RouterLink to="/carrinho" class="flex flex-col items-center relative"
      ...
      <RouterLink to="/favoritos" class="flex flex-col items-center"
        :class="{ 'text-indigo-500 dark:text-emerald-400': isActive('/favoritos') }">
        <i class="fas fa-heart text-sm"></i>
        <span class="text-xs mt-1">Favoritos</span>
      </RouterLink>

      <RouterLink to="/perfil" class="flex flex-col items-center"
